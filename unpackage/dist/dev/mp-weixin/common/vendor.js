...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.1.3,198.18.0.1";
  const port = "8090";
  const id = "mp-weixin_qE3FkA";
...
const pages = [
  ...
  {
    path: "pages/mine/admin-rule",
    style: {
      navigationBarTitleText: "管理员操作指引"
    }
  },
  {
